...
Local and remote data administration, publication and app development tool.

== Description ==
Manage local and remote data and databases from the WordPress dashboard. Publish local and remote data on web pages.
Write data driven WordPress apps that run in the WordPress dashboard or on web pages without any programming skills.
Build data entry forms that support CRUD as well as parent-child functionality.
...
Supports local as well as remote database connections.
...
* Export view data to XML, JSON, Excel and CSV
* Import tables
