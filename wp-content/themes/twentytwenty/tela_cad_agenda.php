...
$tel_pri = $cd_end= $id_cli = $nm_ctt = $dt_agenda = $agenda = "";
$id_agenda = 0;
...
if(isset($_GET['id'])){
 ...
 function load(){
    global $cd_cli, $cd_cmp, $cd_end, $cd_ctt, $cd_tp_srv, $dt_agenda, $hr_ini, $hr_fim, $obs_agenda;
 ...
 function form_valido() {
    global $cd_cli, $cd_cmp, $cd_end, $cd_ctt, $cd_tp_srv, $nm_ctt, $dt_agenda, $hr_ini, $hr_fim, $obs_agenda;
